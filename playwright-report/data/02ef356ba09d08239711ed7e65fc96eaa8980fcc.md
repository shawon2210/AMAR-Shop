...
- Name: search-overlay.spec.ts >> Search overlay - focus trapping and Esc close >> body overflow is hidden while overlay is open
- Location: e2e\search-overlay.spec.ts:89:7
