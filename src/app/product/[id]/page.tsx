  ...
  return (
    <div className="app-container py-6 space-y-6 pb-24">
      ...
      <nav className="flex items-center gap-1 text-xs text-secondary">
        <Link href="/" className="inline-flex items-center min-h-11 min-w-11 px-1 -mx-1 hover:text-primary">{t('product.home')}</Link>
        <span className="material-symbols-outlined text-sm">chevron_right</span>
        <Link href={`/category/${product.categoryId}`} className="inline-flex items-center min-h-11 min-w-11 px-1 -mx-1 hover:text-primary">{product.category}</Link>
        <span className="material-symbols-outlined text-sm">chevron_right</span>
