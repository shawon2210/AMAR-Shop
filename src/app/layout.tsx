  ...
  return (
    <html lang="en" className={`${inter.variable} ${notoBengali.variable}`} data-scroll-behavior="smooth" suppressHydrationWarning>
      ...
      <body className="bg-background text-on-background font-sans antialiased" suppressHydrationWarning>
        <a
          href="#main-content"
          className="absolute -top-[100vh] left-4 z-[9999] min-h-11 min-w-11 inline-flex items-center px-4 bg-primary text-white rounded-lg shadow-lg focus:top-4 focus:outline-none focus:ring-2 focus:ring-white/50"
        >
