...
function Sidebar({
    ...
    return (
      <>
        ...
        <aside
          ...
          className={`fixed top-16 left-4 bottom-4 z-50 w-70 max-w-[85vw] bg-[#0f1219] text-white flex flex-col rounded-b-2xl shadow-2xl shadow-black/40 border border-white/5 transition-transform duration-300 ease-out ${
  ...
  return (
    <aside
      ref={sidebarRef}
      className={`fixed top-16 left-4 bottom-4 z-30 text-white flex flex-col rounded-b-2xl border border-white/[0.05] shadow-[0_8px_32px_-4px_rgba(0,0,0,0.12)] transition-all duration-300 ease-out overflow-hidden bg-[#0f1219] ${
