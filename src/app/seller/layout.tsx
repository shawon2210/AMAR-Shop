...
function Sidebar({
  ...
  return (
    <aside
      ref={sidebarRef}
      className={`fixed top-20 left-4 bottom-4 z-30 text-white flex flex-col rounded-2xl border border-white/[0.05] shadow-[0_8px_32px_-4px_rgba(0,0,0,0.12)] transition-all duration-300 ease-out overflow-hidden bg-[#0f1219] ${
