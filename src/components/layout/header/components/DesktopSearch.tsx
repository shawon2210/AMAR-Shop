    ...
    <div className="hidden lg:flex flex-1 justify-center">
      ...
      >
        <div className="relative w-full transition-all duration-200">
          ...
          <div className="w-full h-11 rounded-full border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 pl-11 pr-14 text-sm text-gray-400 dark:text-gray-400 flex items-center text-left transition-all duration-200 group-hover:border-gray-300 cursor-text">
