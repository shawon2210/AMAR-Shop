    ...
    <Link
      ...
      className={
        variant === 'drawer'
          ...
          : 'flex items-center justify-center w-11 h-11 rounded-xl text-gray-600 hover:bg-gray-100 hover:text-primary active:bg-gray-100 transition-all duration-150'
      }
